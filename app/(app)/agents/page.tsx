...
import { AgentsTabs } from "@/components/dashboard/agents/agents-tabs";
  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col gap-6 p-6">
        ...
        <Section tone="base">
          <AgentsTabs mastraAgents={catalog.agents} claudeAgents={roster} />
        </Section>

        {/* Running executions */}
        <Section tone="base">
          <PageHeader eyebrow="Live" title="Running executions" />
